i. Introduction - "Melon Info Sharing"
	
	1. Title : Melon Info Sharing (for android)
	
	2. Description : This service enables users to inquire about various charts of melon and share music information through multiple SNS providers. 
              
    	3. API Usage : Melon, Social Component APII



ii.Sample Project Configuration
	
	1. AndroidManifest.xml file in /OpenPlatform_MSS : It declared permission and Activity for property whenever you use Planet X library.

	2. libs folder in /OpenPlatform_MSS/libs
	...
	3. Defines.java in /OpenPlatform_MSS/src/com/skp/opx/core/client : It defined OAuth Key, SNS key, each API's 
...
iii. Prerequisite
	...
	3. Register application
	   ...
	   3) Must select "SK Planet One ID", "Melon" and "Social" service area, thereby using this application.
...
iv. Configuration
	...
	4. Edit API Authentication Key value at Define.java in OpenPlatform_MSS/src/com/skp/opx/core/client/
	...
	5. Application Registration and Configuration for third party's service
	   ...
	   4) Edit key and ID values issued by third party's service at Define.java in OpenPlatform_MSS/src/com/skp/opx/core/client/
