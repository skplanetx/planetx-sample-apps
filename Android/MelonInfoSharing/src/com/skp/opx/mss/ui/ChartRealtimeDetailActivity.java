...
/**
 * @설명 : 실시간차트 상세 Activity
 * @클래스명 : ChartRealtimeDetailActivity
 * 
 */
public class ChartRealtimeDetailActivity extends Activity implements OnClickListener {
	...
	EntityMelonRealtimeChart 	mMelonEntity;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mGridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent intent = new Intent(ChartRealtimeDetailActivity.this, ShareActivity.class);
		...
		PopupDialogUtil.showProgressDialog(ChartRealtimeDetailActivity.this, getResources().getString(R.string.loading));
	}
	...
	private void initWidgets() {
		...
		mMelonEntity 	= (EntityMelonRealtimeChart)getIntent().getSerializableExtra("ENTITY");
		...
		mTvInfo2.setText(mMelonEntity.albumName);
	...
	public void onClick(View v)
	{
		...
		case R.id.home_bt :
		{
			startActivity(new Intent(ChartRealtimeDetailActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
			break;
		}
		}
	}
