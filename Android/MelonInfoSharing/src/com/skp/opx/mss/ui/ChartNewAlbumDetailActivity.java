...
/**
 * @설명 : 최신앨범 차트 상세 Activity
 * @클래스명 : ChartNewAlbumDetailActivity
 * 
 */
public class ChartNewAlbumDetailActivity extends Activity implements OnClickListener {
	...
	EntityMelonNewAlbumChart 	mMelonEntity;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mGridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent intent = new Intent(ChartNewAlbumDetailActivity.this, ShareActivity.class);
		...
		PopupDialogUtil.showProgressDialog(ChartNewAlbumDetailActivity.this, getResources().getString(R.string.loading));		
	}
	...
	private void initWidgets() {
		...
		mMelonEntity = (EntityMelonNewAlbumChart)getIntent().getSerializableExtra("ENTITY");
	...
	public void onClick(View v)
	{
		...
		case R.id.home_bt :
		{
			startActivity(new Intent(ChartNewAlbumDetailActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
			break;
		}
		}
	}
