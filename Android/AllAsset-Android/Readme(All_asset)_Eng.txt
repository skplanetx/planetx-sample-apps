...
ii.Sample Project Configuration
	...
	1. AndroidManifest.xml file in /OpenPlatform_SVC  : It declared permission and Activity for property whenever you use Planet X library.

	2. libs folder in /OpenPlatform_SVC/libs
	...
	3. Defines.java in /OpenPlatform_SVC/src/com/skp/opx/core/client : It defined OAuth Key, each API's URI 
...
iv. Configuration
	...
	4. Edit API Authentication Key value at Define.java in OpenPlatform_SVC/src/com/skp/opx/core/client/
