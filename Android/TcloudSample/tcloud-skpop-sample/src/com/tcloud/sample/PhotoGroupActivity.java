...
public class PhotoGroupActivity extends BaseGroupActivity {
	public static final String TAG = PhotoGroupActivity.class.getSimpleName();

	@Override
	public void allListClicked(int position) {
	...
	@Override
	public void groupListClicked(final int position) {
		...
		dialog.setOnClickListener(new dialogOnClickListener() {
			...
			public void onClick(buttonType type) {
				if(type == buttonType.View) {
					Intent intent = new Intent(PhotoGroupActivity.this, PhotoListActivity.class);
	...
	@Override
	public void tagListClicked(int position) {
	...
	public void createGroup(String name) {
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onPlanetSDKException(PlanetXSDKException e) {
				Log.d(TAG, "onPlanetXSDKException " + e);
	...
	public void requestTagList() {
		...
		String url = Const.SERVER_URL + "/image/tags?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.GET);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
	...
	@Override
	protected void deleteGroup(final int position) {
		
		String url = Const.SERVER_URL + "/image/groups/" + currentGroupInfo.groupId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
