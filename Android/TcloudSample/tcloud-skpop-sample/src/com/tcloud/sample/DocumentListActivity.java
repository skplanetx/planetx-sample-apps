...
public class DocumentListActivity extends BaseContentListActivity<DocumentData>{
	@Override
	protected void initType() {
		type = MetaDatas.Type.Document;
	}
	...
	protected void searchList() {
		...
		String url = Const.SERVER_URL + "/documents?version=" + Const.API_VERSION 
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onComplete(ResponseMessage result) {
				try {
					...
					datas = MetaDataUtil.getDocumentDatas(getApplicationContext(), entity);
	...
	protected void detailViewActivity(int position) {
		String url = Const.SERVER_URL + "/documents/" + currentData.objectId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.GET);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onComplete(ResponseMessage result) {
				try {
					Map<String, ?> entity = XmlExtractor.parse(result.toString());
					currentData = MetaDataUtil.getDocumentData(DocumentListActivity.this, (Map<String, String>)entity);
					...
					intent.putExtra(DocumentData.DOCUMENT_ID, currentData.documentId);
//					
	...
	protected void addContentToGroup(String id) {
		...
		String url = Const.SERVER_URL + "/document/groups/" + id + "/documents?version=" + Const.API_VERSION;
	...
	protected void requestGroupContentList() {
		...
		String url = Const.SERVER_URL + "/document/groups/" + groupId + "?version=" + Const.API_VERSION 
				+ "&page=1&count=10";
	...
	protected void requestTagContentList() {
		...
		String url = Const.SERVER_URL + "/document/tags/" + tagId + 
	...
	protected void deleteFromGroup() {
		String url = Const.SERVER_URL + "/document/groups/" + groupId + "/documents/" + currentData.objectId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.DELETE);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
