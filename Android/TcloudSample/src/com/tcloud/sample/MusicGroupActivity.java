...
public class MusicGroupActivity extends BaseGroupActivity {
	public static final String TAG = MusicGroupActivity.class.getSimpleName();
		...
		dialog.setOnClickListener(new dialogOnClickListener() {
			...
			public void onClick(buttonType type) {
				if(type == buttonType.View) {
					Intent intent = new Intent(MusicGroupActivity.this, MusicListActivity.class);
	...
	protected void requestTagList() {
		...
		String url = Const.SERVER_URL + "/music/tags?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.GET);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
	...
	protected void deleteGroup(int position) {
		final ProgressDialog progress = ProgressDialog.show(this, LoadString.TITLE, LoadString.TEXT);
		
		String url = Const.SERVER_URL + "/music/groups/" + currentGroupInfo.groupId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
