...
public class PhotoListActivity extends BaseContentListActivity<ImageData> {
	@Override
	protected void initType() {
		type = MetaDatas.Type.Photo;
	}
	...
	protected void searchList() {
		...
		String url = Const.SERVER_URL + "/images?version=" + Const.API_VERSION 
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onComplete(ResponseMessage result) {
				try {
					...
					datas = MetaDataUtil.getPhotoDatas(getApplicationContext(), entity);
	...
	protected void detailViewActivity(int position) {
		...
		String url = Const.SERVER_URL + "/images/" + currentData.objectId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.GET);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onComplete(ResponseMessage result) {
				try {
					Map<String, ?> entity = XmlExtractor.parse(result.toString());
					currentData = MetaDataUtil.getPhotoData(PhotoListActivity.this, (Map<String, String>)entity);
					...
					intent.putExtra(ImageData.IMAGE_ID, currentData.imageId);
//					
	...
	protected void addContentToGroup(String id) {
		...
		String url = Const.SERVER_URL + "/image/groups/" + id + "/images?version=" + Const.API_VERSION;
	...
	protected void requestGroupContentList() {
		...
		String url = Const.SERVER_URL + "/image/groups/" + groupId + "?version=" + Const.API_VERSION 
				+ "&page=1&count=10";
	...
	protected void requestTagContentList() {
		...
		String url = Const.SERVER_URL + "/image/tags/" + tagId + 
	...
	protected void deleteFromGroup() {
		String url = Const.SERVER_URL + "/image/groups/" + groupId + "/images/" + currentData.objectId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.DELETE);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
