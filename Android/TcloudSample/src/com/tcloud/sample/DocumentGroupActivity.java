...
public class DocumentGroupActivity extends BaseGroupActivity {
	public static final String TAG = DocumentGroupActivity.class.getSimpleName();
		...
		dialog.setOnClickListener(new dialogOnClickListener() {
			...
			public void onClick(buttonType type) {
				if(type == buttonType.View) {
					Intent intent = new Intent(DocumentGroupActivity.this, DocumentListActivity.class);
	...
	protected void createGroup(String name) {
		Log.d(TAG, "create Group request");
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onPlanetSDKException(PlanetXSDKException e) {
				Log.d(TAG, "PlanetXSDKException " + e);
	...
	protected void requestTagList() {
		...
		String url = Const.SERVER_URL + "/document/tags?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.GET);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
	...
	protected void deleteGroup(int position) {
		...
		String url = Const.SERVER_URL + "/document/groups/" + currentGroupInfo.groupId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
