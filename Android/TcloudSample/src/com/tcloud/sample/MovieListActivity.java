...
public class MovieListActivity extends BaseContentListActivity<MovieData> {
	@Override
	protected void initType() {
		type = MetaDatas.Type.Video;
	}
	@Override
	protected void searchList() {
		Log.d(TAG, "searchList call");
		
		String url = Const.SERVER_URL + "/movies?version=" + Const.API_VERSION 
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onComplete(ResponseMessage result) {
				try {
					...
					datas = MetaDataUtil.getMovieDatas(getApplicationContext(), entity);
	...
	protected void detailViewActivity(int position) {
		...
		String url = Const.SERVER_URL + "/movies/" + currentData.objectId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.GET);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
		...
		RequestListener requestListener = new RequestListener() {
			...
			public void onComplete(ResponseMessage result) {
				try {
					Map<String, ?> entity = XmlExtractor.parse(result.toString());
					currentData = MetaDataUtil.getMovieData(MovieListActivity.this, (Map<String, String>)entity);
					...
					intent.putExtra(MovieData.MOVIE_ID, currentData.movieId);
//					
	...
	protected void addContentToGroup(String id) {
		...
		String url = Const.SERVER_URL + "/movie/groups/" + id + "/movies?version=" + Const.API_VERSION;
	...
	protected void requestGroupContentList() {
		...
		String url = Const.SERVER_URL + "/movie/groups/" + groupId + "?version=" + Const.API_VERSION 
				+ "&page=1&count=10";
	...
	protected void requestTagContentList() {
		...
		String url = Const.SERVER_URL + "/movie/tags/" + tagId + 
	...
	protected void deleteFromGroup() {
		String url = Const.SERVER_URL + "/movie/groups/" + groupId + "/movies/" + currentData.objectId + "?version=" + Const.API_VERSION;
		RequestBundle requestBundle = new RequestBundle();
		requestBundle.setHttpMethod(HttpMethod.DELETE);
		requestBundle.setResponseType(CONTENT_TYPE.XML);
		requestBundle.setUrl(url);
