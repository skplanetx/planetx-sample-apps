//
//  CyworldFriendGuestBookViewController.m
//  All Asset
//
...
@interface CyworldFriendGuestBookViewController ()

@end

@implementation CyworldFriendGuestBookViewController
...
- (void)requestGuestBook
{
    ...
    NSString *url = [SERVER_SSL stringByAppendingFormat:CY_GUESTBOOK_PATH,[userDictionary valueForKey:STR_ID],THISYEAR];
